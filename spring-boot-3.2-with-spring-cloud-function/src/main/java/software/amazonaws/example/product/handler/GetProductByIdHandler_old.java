...
@Component
public class GetProductByIdHandler_old implements Function<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
	...
	private static final Logger logger = LoggerFactory.getLogger(GetProductByIdHandler_old.class);
